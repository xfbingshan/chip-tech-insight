...
class ArchiveManager:
    def __init__(self) -> None:
        ...
        index_path = self.archive_cfg.get("index_file", "./data/reports/archive_index.json")
    ...
    def archive_reports(self, report_paths: List[str], run_date: Optional[str] = None) -> Dict[str, Any]:
        ...
        archive_dir = self.base_dir / run_date if self.archive_by_date else self.base_dir
