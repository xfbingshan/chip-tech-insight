...
输出 JSON 格式，所有字符串值使用中文。"""
    ...
    def _mock_flash(self, docs: List[Dict]) -> Dict:
        ...
        return {
            "技术名称": f"{category} 方向：{', '.join(keywords[:2])}" if keywords else f"{category} 技术进展",
            "关键创新": [
                "文献聚类显示该方向近期有多项相关研究",
    ...
    def _mock_deep_dive(self, docs: List[Dict]) -> Dict:
        ...
        return {
            ...
            "竞争格局矩阵": [
                {"玩家": "学术界", "技术路线": "前沿探索", "成熟度": "TRL 3-5", "优势": "创新性强", "劣势": "产业化距离远"},
                {"玩家": "头部企业", "技术路线": "工程落地", "成熟度": "TRL 6-8", "优势": "资源整合", "劣势": "披露信息有限"},
            ],
            "优劣势分析": {
